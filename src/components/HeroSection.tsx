        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-xl text-gray-600 max-w-2xl">
              ...
              Diseñado para brindar autonomía, seguridad y confianza a personas
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button
                ...
                className="group bg-blue-800 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-900 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
              >
